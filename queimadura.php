<?php
 ...
 $comando = $pdo->prepare("INSERT INTO anamneseermegencia VALUES($cabeça,'$grau1',$pescoço,'$grau2',$tant,'$grau3',$tpos,'$grau4',$genit,'$grau5',$mid,'$grau6',$mie,'$grau7',$msd,'$grau8',$mse,'$grau9')" );
